...
console.log("============ An example with template literal with ES6 ===============");
const objectArrays = [];
const obje1 = {
    name: 'Naim',
    lastName: 'Latifi'
...
console.log("============ Template tags with ES6  ===============");
...
let myTaggedTemplate = String.raw `This is a multilne template string
  ...
  `;
console.log("Tag template result", myTaggedTemplate);
...
let description = myObject.description;
